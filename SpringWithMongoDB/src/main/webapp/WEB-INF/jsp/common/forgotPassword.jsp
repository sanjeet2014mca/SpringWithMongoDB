...
<script type="text/javascript">
	function confirmFormSubmit() {
		...
		if (r) {
			document.getElementById('submitButton').action = "${pageContext.request.contextPath}/passwordupdate";
		...
		<div class="tab-content">
			...
			<div id="loginn">
				...
				<form action="/passwordupdate" method="POST"
					...
					<div class="field-wrap">
						<input type="text" placeholder="mobile" name="mobile" maxlength="10"
							required autocomplete="off" />
					</div>
					<div class="field-wrap">
						<input type="password" placeholder="Set as New Password" name="password"
							required autocomplete="off" />
					</div>
					<p>
						<a href="http://localhost:8084/login">Home Page</a>
					</p>
					<p class="forgot">
					<a href="http://localhost:8084/authenticate">Log In</a><i
							style="color: blue;">&nbsp;&nbsp;existing member</i>
					</p>
