...
<body class="room-editor editor state-htmlOn-cssOn-jsOn   layout-top     logged-out unsaved">
	<div class="form">
...
<script type="text/javascript">
	function confirmFormSubmit() {
		...
		if (r) {
			document.getElementById('submitButton').action = "${pageContext.request.contextPath}/deleteuser";
